...
const InfideckOffers = () => {
    ...
    const boxanimation = {
        initial: { opacity: "0%" },
        enter: i => ({ opacity: "100%", transition: { duration: 9.95, ease: [0.33, 1, 0.68, 1], delay: 0.075 * i } })
    }
        ...
        <div className='infideck-offer-page'>
            <div className='infideck-offer-contents'>
                ...
                <div className='offer-types-section'>
                    <motion.div whileHover={{ scale: 1.04 }} ref={ref4} variants={boxanimation} initial="initial" animate={inView ? "enter" : ""} className='offer-type-box digimark'>
                    ...
                    <motion.div whileHover={{ scale: 1.04 }} ref={ref4} variants={boxanimation} initial="initial" animate={inView ? "enter" : ""} className='offer-type-box seosmm'>
                    ...
                    <motion.div whileHover={{ scale: 1.04 }} ref={ref4} variants={boxanimation} initial="initial" animate={inView ? "enter" : ""} className='offer-type-box branding'>
                    ...
                    <motion.div whileHover={{ scale: 1.04 }} ref={ref4} variants={boxanimation} initial="initial" animate={inView ? "enter" : ""} className='offer-type-box visualprod'>
                    ...
                    <motion.div whileHover={{ scale: 1.04 }} ref={ref4} variants={boxanimation} initial="initial" animate={inView ? "enter" : ""} className='offer-type-box softdev'>
                    ...
                    <motion.div whileHover={{ scale: 1.04 }} ref={ref4} variants={boxanimation} initial="initial" animate={inView ? "enter" : ""} className='offer-type-box uiuxdes'>
